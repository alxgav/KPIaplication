...
//                   // Cell  H= sheet.getCell(9,row); //ric
//
...
//                            E.getContents(),
//                            F.getContents(),
//                             setValue(pu.getValue(), 0),pr.getValue(),0.00,
//                            c.postach[0],
//                            type,
       ...
       // c = new common();
        ...
        String kateg2 =" ";
            ...
            while (row<sheet.getRows()){
                ...
                Cell  H= sheet.getCell(7,row);//price_i
                ...
                if(A.getContents().startsWith("00")){
                    ...
                    Double price_u =0.00;
                    Double price_i=0.00;
                    if(F.getContents().equals("")){ // genral price
                        price =0.00;
                    } else{
                        NumberCell pr = (NumberCell)F;
                        price = pr.getValue();
                    }
                    if(G.getContents().equals("")){  //rrc
                        price_u=0.00;
                    }else{
                        NumberCell pu = (NumberCell)G;
                        price_u = pu.getValue();
                    }
                    if(H.getContents().equals("")){ //ric
                        price_i=0.00;
                    }else{
                        NumberCell pi = (NumberCell)H;
                        price_i = pi.getValue();
                    }
                    ...
                    p= new Product(A.getContents(),
                                ...
                                E.getContents(),
                                "",
                                setValue(price,0),price_u,price_i, //ceny
                                c.postach[1],
                                kateg,
